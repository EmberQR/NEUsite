function loadCoinSystem(){function d(e){var t=document.getElementById("coin-content");t.innerHTML=`<p>当前金币数：${e.coins}</p>`;let n=document.createElement("table");n.insertRow().innerHTML="<th>时间</th><th>明细</th><th>操作</th>",e.transactions.forEach(e=>{n.insertRow().innerHTML=`
                <td>${e.date}</td>
