...
| 标题 | 板块 | 审核状态 | 审核备注 |
|------|------|------|------|`;for(let e=1;e<=n;e++){var i=`https://download.xn--xhq44jb2fzpc.com/upload/${t}/${e}/status.json`;try{var a=await fetchNoCache(i);if(a.ok){var{title:l,section:s,status:r,note:c,link:d}=await a.json();let e=l||"无标题";"已通过"===r&&d&&(e=`<a href="${d}" target="_blank">${e}</a>`),o+=`
